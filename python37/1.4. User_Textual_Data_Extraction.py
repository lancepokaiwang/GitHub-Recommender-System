...
users = bfs.readJsonFile(name="users_{}_v2".format(REPO), folder="data/users")
...
bfs.writeJsonFile(data=users_textual_data, name="users_{}_textual".format(REPO), folder="data/user_text")
