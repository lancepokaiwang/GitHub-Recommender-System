...
users = bfs.readJsonFile(name="users_{}_textual_valid_purpose".format(REPO), folder="data/validation").items()
...
for userID, items in users:
    ...
    if PRINT_EXAMPLE:
        bfs.writeJsonFile(output_dataset_processed, "processed_user_text_{}_example_valid_purpose".format(REPO), "data/validation")
        PRINT_EXAMPLE = False
...
bfs.writeJsonFile(output_tf_idf, "users_tf_" + REPO + "_valid_purpose", "data/validation")
...
bfs.writeJsonFile(output_tf_idf, "users_tf_idf_" + REPO + "_valid_purpose", "data/validation")
bfs.writeJsonFile(output_dataset_processed, "processed_user_text_" + REPO + "_valid_purpose", "data/validation")
