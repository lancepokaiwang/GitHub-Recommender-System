...
issues = bfs.readJsonFile(name="users_tf_idf_{}_valid_purpose".format(REPO), folder="data/validation").items()
...
bfs.writeJsonFile(data=issue_profiles, name="profile_users_{}_valid_purpose".format(REPO), folder="data/validation")
